...
RCT_EXPORT_METHOD(toggleTabs:(NSString*)containerId actionParams:(NSDictionary*)actionParams) {
	[_commandsHandler toggleTabs:containerId actionParams:actionParams];
}
